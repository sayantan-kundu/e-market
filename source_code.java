...
public class dr {
    ...
    public static void main(String[] args) {
         ...
         {     // for new user upto line 136
            ...
            if (option == JOptionPane.OK_OPTION)
            {
                ...
                {                 
                    ...
                    conn20= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
                    ...
                    while (rs20.next())
                    {
                        ...
                        if( username20.equals(username))//used to check if the entered user name exist or not
                            flag20=1;
                ...
                if( flag20 == 0)//if we go for new user and user name is distinct from the exsisting ones.
                {
                    flag10=1;
                    ...
                    {
                        Class.forName("com.mysql.jdbc.Driver");
                        conn= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
        ...
        else   // for existing user  upto line 256
        {   
            ...
            "User Name", field1,"Password", field2};
             ...
             try
             {
                 ...
                 Class.forName("com.mysql.jdbc.Driver");
                 conn5= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
			...
			flag5=1;
                        ...
                        try
                        {
                            if(JOptionPane.showConfirmDialog(null,"Do You Want To See  Items That Are Already Bought By You","Recommendationa",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
                            {

                                Connection conn60 = null;
                                Class.forName("com.mysql.jdbc.Driver");
                                conn60= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
                            ...
                            // stored in shopping basket
                                ...
                                while (rs60.next())
                                {
                                    ...
                                    Class.forName("com.mysql.jdbc.Driver");
                                    conn70= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
					...
					String o = "Item Number is "+item_no1+"\n"+"Item Name is "+item_name+"\n"+"Company is "+company+"\n"+"Price is "+price1;
    ...
    {    
        ...
        while( c==1)
        {
            ...
            while (rs.next())
            {
                ...
                bill= bill + price*n;
                JOptionPane.showMessageDialog ( null,"You Are Going To Buy "+item_name );
                
                try
                {
                    Connection conn40=null;
                    Class.forName("com.mysql.jdbc.Driver");
                    conn40= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");       
                ...
                Class.forName("com.mysql.jdbc.Driver");
                conn2= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
            ...
            {           
                ...
                if( int1==1){
                    ...
                    Class.forName("com.mysql.jdbc.Driver");
                    conn1= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
                    ...
                    while (rs.next())
                    {
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                Class.forName("com.mysql.jdbc.Driver");
                                conn30= DriverManager.getConnection("jdbc:mysql://localhost:3306/world","sayantan","1234");
                                int la=amount-bill;
